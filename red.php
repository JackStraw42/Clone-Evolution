                ...
                <div class="container">
                    <div class="row">     
                        ...
                        <div class="sec-title text-center" style="padding-top: 30px;">
                            <h2 class="wow animated bounceInLeft" style="margin-bottom: -20px;"><font color="red">Red Clones</font></h2>
                    ...
                    <div class="row"> 
                        <div class="col-md-4 col-sm-8 col-xs-16 text-center wow animated zoomIn" style="padding-bottom: 10px;">
                            ...
                            <center>
                            <table class="summary">
                            	<tr><td colspan="3" style="background-color: red;"><center><b>Red Clones</b></center></td></tr>
                                <?
								$result = mysql_query("SELECT * FROM red_missing WHERE user = '".$user."' AND total_missing = '0' ORDER BY ".$orderby);
								while ($row = mysql_fetch_array($result)){
									...
									?>
                                    <tr>
                                    	<td style="background-color: <? echo $color;?>; border-right: none;"><center><img src='img/reds/<? echo $row['clone'];?>.jpg' height='40' style="padding-right: 5px;"></center></td>
                                        <td style="background-color: <? echo $color;?>; border-left: none;">
                                        	<font style=" <? echo $font_shrink;?>">
												<a class="fancybox" href="https://olfactoryhues.com/clone-evolution/red_recipe.php?clone=<? echo $row['clone'];?>" data-fancybox-type="iframe" title="<? echo $row['clone'];?>" style="text-decoration: none; color: black;"><? echo $row['clone'];?></a>
											</font>
											<?
											$total_chests = 0;
											$previous_chest = "";
                                        ...
                                        <td style="background-color:#CCC;"><center><a class="fancybox btn btn-primary" href="https://olfactoryhues.com/clone-evolution/craft_red.php?clone=<? echo $row['clone'];?>" data-fancybox-type="iframe" title="<? echo $row['clone'];?>">Make It!</a></td>
                                    </tr>
                                    <?
								}
                                ?>
                    ...
                    <div class="row"> 
                            ...
                            <div class="col-md-4 col-sm-8 col-xs-16 text-center wow animated zoomIn" style="padding-bottom: 10px;">
                                ...
                                <table id="need1" class="summary">
                                    <tr><td colspan="3" style="background-color: red;"><center><b>Red Clones</b></center></td></tr>
                                    <?
                                    $result = mysql_query("SELECT * FROM red_missing WHERE user = '".$user."' AND total_missing = '".$i."' ORDER BY ".$orderby);
									while ($row = mysql_fetch_array($result)){
										$inc++;
										$color_result = mysql_query("SELECT * FROM red WHERE clone = '".$row['clone']."'");
										$color_row = mysql_fetch_array($color_result);
