                                        ...
                                        <table style="background-color: <? echo $set_row['bg_color'];?>; width: 350px;">
                                            ...
                                            <tr style="border: 1px solid #000;">
                                            	<td align="center" style="padding: 10px;">
                                                    <img src="img/chips/<? echo $chip_row['required_chip1'];?>.png" width="30"> <? echo $chip_row['required_chip1'];?> + 
                                                    <img src="img/chips/<? echo $chip_row['required_chip2'];?>.png" width="30"> <? echo $chip_row['required_chip2'];?>
                                                </td>
                                            </tr>
                                            <tr style="border: 1px solid #000;">
                                                <td align="center" valign="top" style="padding: 5px;">
                                                	<?
													// calculate what chips are still needed to craft this chip.
													...
													if ($can_make) {
														...
														if (!empty($used_chests)) {
															echo "<br>Chests used: ";
															$parts = array();
															foreach ($used_chests as $ct => $info) {
																$parts[] = $info['qty'] . " " . $ct . " Chip Chest for " . implode(" and/or ", $info['for']);
															}
															echo implode("; ", $parts) . ".";
														}
													} else {
														...
														if ($remaining_need1 > 0) {
															$needs[] = $remaining_need1 . " gold " . $chip1;
														}
														if ($remaining_need2 > 0) {
															$needs[] = $remaining_need2 . " gold " . $chip2;
														}
														echo "Still need " . implode(" and ", $needs) . ".";
														if (!empty($used_chests)) {
															echo "<br>Chests used: ";
															$parts = array();
															foreach ($used_chests as $ct => $info) {
